import type {
  PermissionResolverOR,
  PermissionResolverAND,
  PermissionResolverCHAIN,
  PermissionResolverAllow,
  PermissionResolverNOT,
  PermissionResolverDeny,
...
const or: PermissionResolverOR = resolvers => async props => {
  ...
  return typeof successResult !== 'undefined' ? true : errorResult;
};
